...
public abstract class Gracz {
    ...
    public Gracz(String imię, String nazwisko, int pesel, Kwota środki) throws NieprawidłoweDane {
        if (imię == null) throw new NieprawidłoweDane("Imię nie może być null.");
        if (nazwisko == null) throw new NieprawidłoweDane("Nazwisko nie może być null.");
        if (pesel <= 0) throw new NieprawidłoweDane("PESEL musi być dodatnią liczbą całkowitą.");
        if (środki == null) throw new NieprawidłoweDane("Środki finansowe nie mogą być null.");
    ...
    public String toString() {
        ...
        if (zakupioneKupony.isEmpty()) {
            ...
            for (Kupon kupon : zakupioneKupony) {
                sb.append(" - ").append(kupon.getIdentyfikator()).append('\n');
            }
        }
    ...
    public void oddajKupon(Kupon kupon) {
        if (!zakupioneKupony.remove(kupon)) {
