...
import main.java.totolotek.centrala.losowanie.Losowanie;
...
public class TestLosowaniaOrazWyniku {
    ...
    void testKonstruktora() throws NieprawidłoweDane {
        ...
        assertEquals(1, losowanie.getNrLosowania(), "Numer losowania powinien być ustawiony " +
                "poprawnie");
    ...
    void testZbieranieKuponów() throws NieprawidłoweDane, BrakŚrodków {
        ...
        Minimalista gracz = new Minimalista("Jan", "Kowalski", 123456789,
    ...
    void testGetTrafienia() throws NieprawidłoweDane, BrakŚrodków {
        ...
        assertEquals(0, losowanie.getTrafienia(0), "Nieprawidłowy stopień powinien " +
                "zwrócić 0");
        assertEquals(0, losowanie.getTrafienia(5), "Nieprawidłowy stopień powinien " +
                "zwrócić 0");
    }
    ...
    void testWynikKonstruktor() throws NieprawidłoweDane {
        Losowanie losowanie = new Losowanie(1);
        Kwota[] wygraneKwoty = {new Kwota(1000, 0), new Kwota(500, 0),
                new Kwota(100, 0), new Kwota(50, 0)};
        Kwota[] puleNagród = {new Kwota(10000, 0), new Kwota(5000, 0),
                new Kwota(1000, 0), new Kwota(500, 0)};
    ...
    void testWynikNieprawidłowaLiczbaTrafień() throws NieprawidłoweDane {
        Losowanie losowanie = new Losowanie(1);
        Kwota[] wygraneKwoty = {new Kwota(0, 0), new Kwota(0, 0),
                new Kwota(0, 0), new Kwota(0, 0)};
        Kwota[] puleNagród = {new Kwota(0, 0), new Kwota(0, 0),
                new Kwota(0, 0), new Kwota(0, 0)};
        int[] trafioneZakłady = {1, 2, 5, 10};
    ...
    void testUnikalnośćWylosowanychLiczb() throws NieprawidłoweDane {
        ...
        assertTrue(różne, "Losowania powinny generować różne wyniki (bardzo wysokie " +
                "prawdopodobieństwo)");
    }
}
