...
public class TestKolektury {
    ...
    void testPoczątkowegoStanu() {
        ...
        assertNotNull(kolektura.getSprzedaneKupony(), "Lista sprzedanych kuponów powinna być " +
                "zainicjalizowana");
        assertTrue(kolektura.getSprzedaneKupony().isEmpty(), "Lista sprzedanych kuponów powinna być " +
                "początkowo pusta");
    ...
    void testResetNumeracji() {
        ...
        Kolektura k2 = new Kolektura();
        assertEquals(1, k2.getNrKolektury(), "Po resecie numeracji, nowa kolektura powinna " +
                "mieć numer 1");
    }
    ...
    void testSprzedajKuponZBlankietu() throws NieprawidłoweDane, BrakŚrodków {
        ...
        assertEquals(1, kolektura.getSprzedaneKupony().size(), "Kolektura powinna mieć " +
                "sprzedany jeden kupon");
    ...
    void testSprzedajKuponZBlankietuBrakŚrodków() throws NieprawidłoweDane {
        ...
        assertEquals(0, kolektura.getSprzedaneKupony().size(), "Kolektura nie powinna " +
                "mieć sprzedanych kuponów");
    }
    ...
    @Test
    void testSprzedajKuponChybiłTrafiłBrakŚrodków() throws NieprawidłoweDane {
        Kolektura kolektura = new Kolektura();
        Gracz gracz = generujGraczaZPieniędzmi(new Kwota(0, 0), kolektura);
        ...
        assertEquals(0, kolektura.getSprzedaneKupony().size(), "Kolektura nie powinna mieć " +
                "sprzedanych kuponów");
    }
